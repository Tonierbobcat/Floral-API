...
public class PlayerResources extends ProfileComponent implements Mappable<Map<String, Object>> {

    private final Map<Resource, ResourceInstance> resources = new HashMap<>();

    public PlayerResources(PlayerProfile profile) {
        super(profile);
    ...
    public PlayerResources(PlayerProfile profile, Map<String, Map<String, Object>> resources) {
        super(profile);
